...
public class OrderIOHelper {
    public static void addClient(OrderService orderService,
                                 ClientService clientService,
                                 StaffService staffService) throws Exception {
    ...
    public static void deleteOrder(OrderService orderService) throws Exception {
        Scanner sc = new Scanner(System.in);
    ...
    public static void getALl(OrderService orderService) throws JsonProcessingException {
